...
module.exports.index = function (req, res) {
  ...
  if (hook) {
    ...
    case 'help':
      res.json({ text: 'Powered by https://github.com/Aaron7/slack-pongbot fork\n' +
        ...
        '`pongbot accept`\n' +
        '`pongbot decline`\n' +
        'or the challenger may `pongbot chicken`\n' +
        '*The defeated must then declare the result:*\n' +
        '`pongbot lost`\n' +
        '*Other commands:*\n' +
        '`pongbot leaderboard`\n' +
        '`pongbot rank <name>` (or no name to see your own rank)'
      });
      break;
